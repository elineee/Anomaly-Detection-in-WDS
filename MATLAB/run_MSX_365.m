...
% % % % %%=== Load MSX ===
msx_filename = './Challenge/AI_challenge365days.msx';
d.loadMSXFile(msx_filename);  % Load compiled MSX file
load('contamination_metadata_365days.mat'); % needed for event_map and patterns
...
save('./AI_Challenge_step_by_step_MSX_API_365days_final.mat', 'value', 'species_names');
